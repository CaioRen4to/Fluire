...
class TelaDetalheAluno extends StatelessWidget {
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Text('Detalhes', style: AppTypography.titleLarge.copyWith(color: AppColors.textoPrimario)),
                      ...
                      child: Column(
                        children: [
                          CircleAvatar(
                            ...
                            child: Text('${aluno['inicial']}', style: TextStyle(fontSize: AppTypography.fontSizeH2, fontWeight: AppTypography.fontWeightBold, color: Colors.white)),
                          ),
                          AppSpacing.gapMd,
                          Text('${aluno['nome']}', style: TextStyle(fontSize: AppTypography.fontSizeXl, fontWeight: AppTypography.fontWeightBold, color: Colors.white)),
                          AppSpacing.gapXs,
                          Text('${aluno['modalidade']}', style: TextStyle(fontSize: AppTypography.fontSizeSm, color: AppColors.primariaClara)),
                          AppSpacing.gapMd,
                          Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Text(ativo ? 'Ativo' : 'Inativo', style: TextStyle(color: Colors.white, fontWeight: AppTypography.fontWeightSemiBold)),
                              ],
                            ),
                          ),
                        ],
                                  ...
                                  Expanded(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text('${h['data']}', style: TextStyle(fontSize: AppTypography.fontSizeSm, color: AppColors.textoSecundario)),
                                      ],
                                    ),
                                  ),
  ...
  Widget _bloco(String titulo, Widget conteudo) => Container(
        ...
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text(titulo, style: AppTypography.titleMedium.copyWith(color: AppColors.textoPrimario)),
            AppSpacing.gapMd,
            conteudo,
          ],
        ),
